...
import json
from factory.dag.generate_table import (
    load_csv_to_gcs,
    load_postgres_to_csv,
    load_to_bigquery,
)
...
with DAG(
    ...
    start_dag_nofi = BashOperator(
        task_id="start_dag_nofi", bash_command='echo "Start DAG"'
    )
    ...
    for table_name in schema.keys():
        ...
        (
            start_dag_nofi
            >> load_postgres_to_csv_task
            >> load_csv_to_gcs_task
